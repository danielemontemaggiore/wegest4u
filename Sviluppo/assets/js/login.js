    ...
    $.ajax({
      ...
      success: function(msg)
      {
		...
		if(risposta=="Ok"){
			...
			var a3 = jsonData.a3;
			var a4 = jsonData.a4;
				window.location.assign("http://www.workingroupitalia.it/app_sviluppo/menu.html?ID_attivita=" + ID_attivita + "&ID_punto=" + ID_punto + "&ID_culture=" + ID_culture + "&ID_operatore=" + ID_operatore +"&Scadenza=" + Scadenza + "&a1=" + a1 + "&a2=" + a2 + "&a3=" + a3 + "&a4=" + a4);
		}
		else{
			var Testo_errore = jsonData.Testo_errore;
				window.location.assign("http://www.workingroupitalia.it/app_sviluppo/index.html?Testo_errore=" + Testo_errore);
		}
	 },
      error: function()
      {
